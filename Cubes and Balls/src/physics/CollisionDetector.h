...
public:
	...
	bool IsColliding(std::shared_ptr<Object> toTest, Collision &outputCollission);

	bool Colliding(std::shared_ptr<Object> first, std::shared_ptr<Object> second, Collision &outputCollission);
private:
